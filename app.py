...
st.caption(
    ...
    "Propuesta de alto nivel basada en reglas — decisiones finales del equipo."
)
...
st.caption(
    "⚠️ Esta propuesta es un MVP didáctico. "
    "Las decisiones finales deben ser validadas por el equipo y el tutor."
)
